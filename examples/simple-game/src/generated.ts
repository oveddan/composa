// Generated by @wagmi/cli@0.1.11 on 2/28/2023 at 1:05:59 PM
import {
  useNetwork,
  useContract,
  UseContractConfig,
...
export function useCounter(
  config: Omit<UseContractConfig, 'abi' | 'address'> & { chainId?: keyof typeof counterAddress } = {} as any
) {
  const { chain } = useNetwork();
  const chainId = config.chainId ?? chain?.id;
  return useContract({ abi: counterABI, address: counterAddress[chainId as keyof typeof counterAddress], ...config });
}
 ...
 * -
 */
export function useCounterNumber<TSelectData = ReadContractResult<typeof counterABI, 'number'>>(
  config: Omit<UseContractReadConfig<typeof counterABI, 'number', TSelectData>, 'abi' | 'address' | 'functionName'> & {
    chainId?: keyof typeof counterAddress;
  } = {} as any
) {
  const { chain } = useNetwork();
...
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof counterABI, string>['abi'], TFunctionName> & {
        address?: Address;
        chainId?: TChainId;
      }
...
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof counterABI, 'increment'>['abi'], 'increment'> & {
        address?: Address;
        chainId?: TChainId;
...
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof counterABI, 'setNumber'>['abi'], 'setNumber'> & {
        address?: Address;
        chainId?: TChainId;
...
export function usePrepareCounterIncrement(
  config: Omit<UsePrepareContractWriteConfig<typeof counterABI, 'increment'>, 'abi' | 'address' | 'functionName'> & {
    chainId?: keyof typeof counterAddress;
  } = {} as any
) {
  const { chain } = useNetwork();
...
export function usePrepareCounterSetNumber(
  config: Omit<UsePrepareContractWriteConfig<typeof counterABI, 'setNumber'>, 'abi' | 'address' | 'functionName'> & {
    chainId?: keyof typeof counterAddress;
  } = {} as any
) {
  const { chain } = useNetwork();
...
export function useCounterTransferEvent(
  config: Omit<UseContractEventConfig<typeof counterABI, 'Transfer'>, 'abi' | 'address' | 'eventName'> & {
    chainId?: keyof typeof counterAddress;
  } = {} as any
) {
  const { chain } = useNetwork();
